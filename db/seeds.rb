...
john = User.new(first_name: "John", last_name:"Doe", email:"johndoe@gmail.com", password:"password", event_organiser: false, service:"Chef", bio:"Experienced Chef")
john.save
andrew = User.new(first_name: "Andrew", last_name:"Smith", email:"andrewsmith@gmail.com", password:"password", event_organiser: true, bio:"Looking for chef")
andrew.save
